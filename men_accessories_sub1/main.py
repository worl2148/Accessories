...
# Hardcoded subcategory URLs for Men's Accessories
SUBCATEGORY_URLS = [
    "https://www.boutiqaat.com/ar-kw/men/traditional-wear/prayer-beads/l/",
    "https://www.boutiqaat.com/ar-kw/men/accessories/gift-sets/l/",
    "https://www.boutiqaat.com/ar-kw/men/accessories/caps-beanies/l/",
    "https://www.boutiqaat.com/ar-kw/men/accessories/bands-gloves/l/",
    "https://www.boutiqaat.com/ar-kw/men/accessories/pens/l/",
    "https://www.boutiqaat.com/ar-kw/men/accessories/men-scarves/l/",
]
...
class BoutiqaatDataPipeline:
    ...
    def run(self) -> bool:
        ...
        logger.info("=" * 80)
        logger.info("Starting Men's Accessories Pipeline (Async – Semaphore=3)")
        logger.info("=" * 80)
        try:
    ...
    def _upload_product_image(self, product: Dict, category_name: str, subcategory_name: str) -> str:
        ...
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/men/accessories/images/"
                f"{safe_category}"
            )
    ...
    def _upload_excel_file(self, local_path: str, category_name: str) -> bool:
        ...
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/men/accessories/excel-files"
            )
